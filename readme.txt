...
Tags: sLaNGjIs, memory, limit, wp, overview, lite, mu, show, usage, dashboard, load, footer,
Stable tag: 2010.1010.2016.0
Requires at least: 2.7
Tested up to: 2.9
License: GPLv2 or later
License URI: https://www.gnu.org/licenses/gpl-2.0.html

show overview and memory usage widgets on wordpress dashboard, with less load consumption. full compatible with wp 2.9.2 mu. work under gplv2 license.

== Description ==

Show Overview and memory usage widgets on WordPress dashboard, with less load consumption. Full compatible with WP 2.9.2 MU. Work under GPLv2 License.

Author Website: [slangji.wordpress.com](https://slangji.wordpress.com/) - Author Repositories: [github.com/slangji](https://github.com/slangji)

[Find More on sLa Developer Page @ SoftPedia.com](https://webscripts.softpedia.com/author/sLa-1869786722.html)
...
* [Plugins](https://slangji.wordpress.com/plugins/):
 * [WP Overview (lite)](https://wordpress.org/plugins/wp-overview-lite/)
 * [WP Overview (lite) MU](https://wordpress.org/plugins/wp-overview-lite-mu/)
 * [WP Overview (lite) MS](https://wordpress.org/plugins/wp-overview-lite-ms/)
 * [WP Missed Schedule](https://wordpress.org/plugins/wp-missed-schedule/)
 * [WP Admin Bar Removal](https://wordpress.org/plugins/wp-admin-bar-removal/) Linked and reviewed at [softpedia.com](http://webscripts.softpedia.com/script/Modules/WordPress-Plugins/Admin-Bar-Removal-completely-disable-73547.html)
 * [WP Admin Bar Node Removal](https://wordpress.org/plugins/wp-admin-bar-node-removal/)
 * [WP Toolbar Removal](https://wordpress.org/plugins/wp-toolbar-removal/) Linked and reviewed at [softpedia.com](http://webscripts.softpedia.com/script/Modules/WordPress-Plugins/ToolBar-Removal-completely-disable-73548.html)
 * [WP Toolbar Node Removal](https://wordpress.org/plugins/wp-toolbar-node-removal/)
 * [Noindex (login) WordPress Deindexing](https://wordpress.org/plugins/wp-login-deindexing/)
 * [Noindex (total) WordPress Deindexing](https://wordpress.org/plugins/wp-total-deindexing/)
 * [IE Enhancer and Modernizer](https://wordpress.org/plugins/wp-ie-enhancer-and-modernizer/) Linked and reviewed at [softpedia.com](https://webscripts.softpedia.com/script/Modules/WordPress-Plugins/IE-Enhancer-and-Modernizer-73546.html)
 * [Memory Load Consumption db size Usage Indicator](https://wordpress.org/plugins/wp-memory-db-indicator/)
 *
 * [Memory Bump](https://wordpress.org/plugins/memory-bump/) for [Ticket #13847](https://core.trac.wordpress.org/ticket/13847) troubleshooting.
 * [Health Check](https://wordpress.org/plugins/health-check/) verify if the PHP and MySQL versions of your server are not too low to meet the requirements that we have announced for WordPress 3.2.

Work under [GPLv2](https://www.gnu.org/licenses/gpl-2.0.html) License.
...
2. Activate of WP Overview (lite) should be `Automatic` ;)
 ...
 *  This program is free software; you can redistribute it and/or
    ...
    as published by the Free Software Foundation; either [version 2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)
...
RESOLVED [WP3 exceed 256 memory limit](https://wordpress.org/support/topic/wp3-exeed-256-memory-limit?replies=5)
...
This is a very high value, and is not announced in the minimum WordPress requirements since the 2.7 version. See also: [Technical WordPress Installation Checklist](https://codex.wordpress.org/User:Hakre/Technical_Installation)
Because raising the memory limit over your servers allowance can crash your blog on some servers, or shared hosting, (Fatal Error: Allowed Memory Size Exhausted) it’s adviseable, previous to upgrade, increase your WordPress Memory Limit with third part plugins like [Memory Bump](https://wordpress.org/plugins/memory-bump/), and check how much PHP or WP Memory your server allows with WP Overview or similar.
If it’s below 256 Megabytes this could render your blog useless after upgrade, and it means you need to increase your WordPress Memory Limit. Related Ticket: [Ticket #13847](https://core.trac.wordpress.org/ticket/13847)
For this bug #13847 [WP Overview (lite)](https://wordpress.org/plugins/wp-overview-lite/) and [WP Overview (lite) MU](https://wordpress.org/plugins/wp-overview-lite-mu/) need another upgrade to work fine on WP 3.0 environment.
The fix is already online on my reposytory [lite](https://plugins.svn.wordpress.org/wp-overview-lite/trunk/) and [mu](https://plugins.svn.wordpress.org/wp-overview-lite-mu/trunk/) and it official released after [WP 3.0.1](https://core.trac.wordpress.org/milestone/3.0.1) launch.
...
== Screenshots ==
[Screenshot](https://plugins.trac.wordpress.org/browser/wp-overview-lite-mu/branches/screenshots/screenshot.jpg) of the WP Overview (lite) MU on WordPress `2.9.2` Dashboard.
 ...
 * Please update as soon possible!
 * RESOLVED [WP3 exceed 256 memory limit](https://wordpress.org/support/topic/wp3-exeed-256-memory-limit?replies=5)
 * FIXED [Ticket #13847](https://core.trac.wordpress.org/ticket/13847)
...
The final release of this plugin is splitted on two separated versions to improved stability and security. Want you to standard version now? [Download](https://wordpress.org/plugins/wp-overview-lite/) it from here!
